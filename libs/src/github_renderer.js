https://github.com/yusanshi/emgithub/blob/master/embed-v2.js on 2024.12.01
(() => {
  ...
  const serviceProvider = new URL("./", sourceURL.origin).href;
...
<div id="${containerId}" class="emgithub-container">
  ...
  <div class="emgithub-file emgithub-file-${isDarkStyle ? 'dark' : 'light'}"
    ...
    ${showFileMeta ? `<div class="file-meta file-meta-${isDarkStyle ? 'dark' : 'light'}"
      ...
      hosted <span>with ❤ </span>by <a target="_blank" href="https://github.com/">GitHub</a>
    </div>`: ''
    }
